...
import com.blink.browser.addbookmark.FolderSpinner;
import com.blink.browser.addbookmark.FolderSpinnerAdapter;
import com.blink.browser.provider.BrowserContract;
import com.blink.browser.provider.BrowserContract.Accounts;
import com.blink.browser.reflection.InputMethodManagerExtension;
...
public class AddBookmarkPage extends Activity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mCancelAddBookmark = (TextView) findViewById(R.id.cancel_add_bookmark);
        mSavedBookmark = (TextView) findViewById(R.id.saved_add_bookmark);
    ...
    private static class InnerHandler extends Handler {
        ...
        private WeakReference<AddBookmarkPage> mAddBookmarkPageHolder;

        public InnerHandler(AddBookmarkPage addBookmarkPage) {
            this.mAddBookmarkPageHolder = new WeakReference<>(addBookmarkPage);
        }

        @Override
        public void handleMessage(Message msg) {
            AddBookmarkPage addBookmarkPage = mAddBookmarkPageHolder.get();
