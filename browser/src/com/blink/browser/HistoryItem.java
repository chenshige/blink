...
public class HistoryItem extends HorizontalScrollView {
    ...
    HistoryItem(Context context) {
        ...
        mTextView = (TextView) findViewById(R.id.title_history_item);
        mUrlText = (TextView) findViewById(R.id.url_history_item);
        mImageView = (RoundImageView) findViewById(R.id.logo_history_item);
        mCloseTv = (ImageView) findViewById(R.id.close_history_item);
    }
    ...
    /* package */ void setFavicon(Bitmap b) {
        if (b != null) {
            ...
            mImageView.setImageResource(R.drawable.ic_browser_default_http);
        }
    }
