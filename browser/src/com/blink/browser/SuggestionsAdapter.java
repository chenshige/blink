...
import com.blink.browser.provider.BrowserProvider2.OmniboxSuggestions;
...
public class SuggestionsAdapter extends BaseAdapter implements Filterable,
    ...
    public void setIsShowClipboard(boolean isShowClipboard) {
        mIsShowClipboard = isShowClipboard;
    }
    ...
    private void bindView(View view, SuggestItem item) {
        ...
        switch (item.type) {
            case TYPE_SUGGEST:
            case TYPE_SEARCH:
                id = R.drawable.ic_browser_home_swipe_left_search;
                break;
            case TYPE_BOOKMARK:
    ...
    class SuggestFilter extends Filter {
        ...
        void startSuggestionsAsync(final CharSequence constraint) {
            if (!mIncognitoMode && !mIsShowClipboard) {
        ...
        protected void publishResults(CharSequence constraint, FilterResults fresults) {
            if (fresults == null || mIsShowClipboard) {
                return;
            }
