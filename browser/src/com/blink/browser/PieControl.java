...
import com.blink.browser.view.PieItem;
import com.blink.browser.view.PieMenu;
import com.blink.browser.view.PieMenu.PieView.OnLayoutListener;
import com.blink.browser.view.PieStackView;
import com.blink.browser.view.PieStackView.OnCurrentListener;
...
public class PieControl implements PieMenu.PieController, OnClickListener {
    ...
    public boolean onOpen() {
        DisplayUtil.resetTabSwitcherTextSize(mTabsCount,mUiController.getTabControl().getTabCount());
    ...
    protected void populateMenu() {
        ...
        mAddBookmark = makeItem(R.drawable.ic_browser_home_bookmark, 1);
        mRefresh = makeItem(R.drawable.ic_refresh_holo_dark, 1);
        mForward = makeItem(R.drawable.ic_forward_holo_dark, 1);
        mNewTab = makeItem(R.drawable.ic_browser_plus, 1);
        mIncognito = makeItem(R.drawable.ic_new_incognito_holo_dark, 1);
        mClose = makeItem(R.drawable.ic_browser_incognito_clear, 1);
        mInfo = makeItem(android.R.drawable.ic_menu_info_details, 1);
        mFind = makeItem(R.drawable.ic_browser_home_swipe_left_search, 1);
        mShare = makeItem(R.drawable.ic_browser_home_other_share, 1);
