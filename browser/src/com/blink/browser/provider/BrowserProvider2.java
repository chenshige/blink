...
package com.blink.browser.provider;
...
import com.blink.browser.BrowserHelper;
import com.blink.browser.BrowserHelper.BookmarkColumns;
...
import com.blink.browser.provider.BrowserContract.ChromeSyncColumns;
...
import com.blink.browser.provider.BrowserContract.Searches;
import com.blink.browser.provider.BrowserContract.Settings;
import com.blink.browser.provider.BrowserContract.SyncState;
import com.blink.browser.util.BuildUtil;
import com.blink.browser.widget.BookmarkThumbnailWidgetProvider;
...
public class BrowserProvider2 extends SQLiteContentProvider {
    ...
    //this is default bookmark timestamp
    ...
    private static final String[] SUGGEST_PROJECTION = new String[]{
            ...
            bookmarkOrHistoryLiteral(Combined.URL,
                    ...
                    Integer.toString(R.drawable.ic_bookmark_on_holo_dark)),
    ...
    static final Map<String, String> ACCOUNTS_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> BOOKMARKS_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> OTHER_BOOKMARKS_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> HISTORY_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> SYNC_STATE_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> IMAGES_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> COMBINED_HISTORY_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> COMBINED_BOOKMARK_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> SEARCHES_PROJECTION_MAP = new ArrayMap<>();
    static final Map<String, String> SETTINGS_PROJECTION_MAP = new ArrayMap<>();
    ...
    final class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            browserSQLiteHelper.onCreate(db);
            browserSQLiteHelper.initData(db);
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            browserSQLiteHelper.onUpgrade(db, oldVersion, newVersion);
        }
        ...
        private void addDefaultBookmarks(SQLiteDatabase db, long parentId) {
            ...
            try {
                ...
                String now = DEFAULT_BOOKMARK_TIME;
    ...
    public SQLiteOpenHelper getDatabaseHelper(Context context) {
        synchronized (this) {
            if (mOpenHelper == null) {
                ...
                browserSQLiteHelper = new BrowserSQLiteHelper(context);
                DatabaseManager.init(mOpenHelper);
            }
        ...
        switch (match) {
            ...
            case COMBINED: {
                if ((match == LEGACY || match == LEGACY_ID)
                        && projection == null) {
                    projection = BrowserHelper.HISTORY_PROJECTION;
                }
        ...
        switch (match) {
            case BOOKMARKS: {
                ...
                if (!callerIsSyncAdapter) {
                    ...
                    if (values.get(Bookmarks.DATE_CREATED) == null) {
