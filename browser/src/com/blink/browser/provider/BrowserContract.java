...
public class BrowserContract {
    ...
    public static final String AUTHORITY = Browser.getInstance().getPackageName();
    ...
    public static final int [] webIconWebArray = {R.color.web_icon_background1, R.color.web_icon_background2,
            R.color.web_icon_background3, R.color.web_icon_background4, R.color.web_icon_background5,
            R.color.web_icon_background6, R.color.web_icon_background7, R.color.web_icon_background8
    };
	...
	public static final String NATIVE_PAGE_URL = "blink-native://homepage";

	// 广告过滤数据
	public static final String ADBLOCK_UPDATE_URL = "https://raw.githubusercontent.com/Dawsey21/Lists/master/adblock-list.txt";
    public static final String EASYLIST_UPDATE_URL = "https://easylist-downloads.adblockplus.org/easyprivacy+easylist.txt";
	...
	public static final String EMPTY_WEB_URL = "https://www.google.com";
	...
	public static final String DOWNLOAD_VIEW_ACTION = AUTHORITY + ".action.download.view";

	public static final String DOWNLOAD_ITEM_ACTION = AUTHORITY + ".action.download";
}
