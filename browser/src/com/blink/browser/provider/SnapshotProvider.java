...
public class SnapshotProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = BrowserContract.AUTHORITY + ".snapshots";
    ...
    private static Method mCopyFileMethod;
    ...
    static {
        ...
        try {
            ...
            mCopyFileMethod = clazz.getDeclaredMethod("copyFile", File.class, File.class);
        } catch (Exception e) {
    ...
    private void migrateToDataFolder() {
        ...
        if (oldPath.exists()) {
            ...
            if (!oldPath.renameTo(dbPath)) {
                ...
                try {
                    mCopyFileMethod.invoke(null, oldPath, dbPath);
                } catch (Exception e) {
                    throw new RuntimeException("Invalid reflect", e);
                }
            }
