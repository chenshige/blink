...
public class BookmarkWidgetProxy extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        } else if (BrowserActivity.ACTION_OPEN_URL.equals(intent.getAction())) {
            Intent uriIntent = new Intent(Intent.ACTION_VIEW, intent.getData(), context, BrowserActivity.class);
            startActivity(context, uriIntent);
        } else {
